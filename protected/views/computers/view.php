...
$this->menu=array(
	array('label'=>'Обновить по сети', 'url'=>array('ScanComputer', 'name'=>$model->name)),
	array('label'=>'Изменить', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Удалить', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Вы уверены, что хотите удалить запись об этом компьютере?')),
			...
			$this->widget('zii.widgets.CDetailView', array(
				...
				'attributes'=>array(				
					array(
						...
						'type' => 'raw',
						'value'=> CHtml::tag('span',array('class'=>'headerTitle'),$PhysicalDrive->model_physical_drives),
					),
					array(
